...
const createTypographyColorVariants = () => {
...
export const typographyColorVariants = styleVariants({ ...createTypographyColorVariants() });

export const typographyTextAlignVariants = styleVariants({
	left: {
		textAlign: 'left',
	},
	center: {
...
export const typographyOtherVariants = styleVariants({
	root: {
		margin: 0,
	},
});
