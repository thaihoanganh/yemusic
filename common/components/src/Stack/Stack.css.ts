...
export const stackBaseVariants = styleVariants({
	root: {
		display: 'flex',
...
export const stackAlignItemsVariants = styleVariants({
	['flex-start']: {
...
export const stackJustifyContentVariants = styleVariants({
	['flex-start']: {
...
export const stackSpacingVariants = styleVariants({
	xsmall: {
...
export const stackPaddingHorizontalVariants = styleVariants({
	xsmall: {
...
export const stackPaddingVerticalVariants = styleVariants({
	xsmall: {
